...
@app.route("/about")
def about():
    return ("Welcome to 'About' page!<br/><br/>"
        f"Climate Application<br/><br/>"
        f"Boot Camp Spot<br/><br/>"
        f"Version 1.0")
